import { Supermarket, productsData } from "/model/supermarket.js";
...
export class SupermarketService {
  constructor() {
    this.supermarket = new Supermarket(productsData);
    this.cardsContainer = document.getElementById("cardsContainer");
    this.cartService = new CartService();
  }

  displayProducts() {
    const allProducts = this.supermarket.getAllProducts();

    console.log("------->Datos de supermarket.js<-------");
    ...
    allProducts.forEach((element) => {
      ...
      const cardContent = `
              ...
              src="/model/img/supermarket/superm.jpeg"
              alt=""
            />              
              </div>
              `;
...
const productManagerInstance = new SupermarketService();
