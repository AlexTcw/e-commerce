import { Technologies, productsData } from "/model/technologies.js";
...
export class TechnologiesService {
  constructor() {
    this.technologies = new Technologies(productsData);
    this.cardsContainer = document.getElementById("cardsContainer");
    this.cartService = new CartService();
  }

  displayProducts() {
    const allProducts = this.technologies.getAllProducts();

    console.log("------->Datos de technologies.js<-------");
    ...
    allProducts.forEach((element) => {
      ...
      const cardContent = `
              ...
              src="/model/img/technologies/tech.jpg"
              alt=""
            />              
              </div>
              `;
...
const productManagerInstance = new TechnologiesService();
