import { Laundry, productsData } from "/model/laundry.js";
...
export class LaundryService {
  constructor() {
    this.laundry = new Laundry(productsData);
    this.cardsContainer = document.getElementById("cardsContainer");
    this.cartService = new CartService();
  }

  displayProducts() {
    const allProducts = this.laundry.getAllProducts();

    console.log("------->Datos de laundry.js<-------");
    ...
    allProducts.forEach((element) => {
      ...
      const cardContent = `
              ...
              src="/model/img/laundry/laundry.jpg"
              alt=""
            />              
              </div>
              `;
...
const productManagerInstance = new LaundryService();
